...
export const CAPCUT_TEMPLATES = [
  {
    ...
    tag: 'F&B / High-Fashion',
    duration: '22.0s',
    photos: '8 Photos',
    desc: 'Hiệu ứng xé giấy lộ halftone đen trắng, cuộn giấy bung nở 3D, thu nhỏ 3 card đa màu và đóng sách nghệ thuật.',
    popular: true,
  },
  {
    id: 'ads_strobe_teaser',
    title: 'Strobe Teaser 11.63s',
    tag: 'Trending CapCut',
    duration: '11.63s',
    photos: '1 or 3 Photos',
    desc: 'Intro xé giấy rực rỡ, nhấp nháy Strobe beat điện ảnh, quét laser và match-to-poster outro.',
    popular: true,
  },
  {
    id: 'product_commercial_style7',
    title: 'Universal Product Ads (Style 7)',
    tag: 'E-Commerce / Billboard',
    duration: '15.0s',
    photos: '1-3 Photos',
    desc: 'Tách nền SAM 2 vật thể trong suốt, chuyển động CapCut billboard 60fps mượt mà.',
    popular: false,
  },
  {
    id: 'flash_sale_countdown',
    title: 'Flash Sale Cyber Countdown',
    tag: 'Voucher / Event',
    duration: '10.0s',
    photos: '4 Photos',
    desc: 'Đếm ngược xung nhịp điện tử, glitch vạch quét radar và hiệu ứng nổ pháo voucher.',
    popular: false,
  },
];
