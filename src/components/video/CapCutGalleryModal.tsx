  ...
  useEffect(() => {
    ...
    wynmotionService.getTemplates().then((res) => {
      if (isMounted && res && res.success && res.templates && res.templates.length > 0) {
        ...
        if (!hasAppleModern) {
          validTemplates.push({
            template_id: 'apple_modern_motion',
            visual_style: 'apple_modern_motion',
            category: 'Chuyển Động Hiện Đại',
            title_vi: 'Modern Motion Suite (Apple Style 50s)',
            title_en: 'Modern Motion Suite (Apple Style 50s)',
            desc_vi: 'Bộ video quảng cáo toàn diện 50s chuẩn Apple Keynote: 3 video demo chính, 5 video trượt mượt mà, hiệu ứng chữ so le dồn dập & Outro thương hiệu tùy chỉnh.',
            desc_en: 'Complete 50s Apple-style suite: 3 hero videos, 5 vertical carousel clips, kinetic staggered typography & custom brand logo outro.',
            cover_url: 'https://static.wordai.pro/ai-generated-images/wynmotion/templates/cover_modern_motion_suite.png',
            cover_ios_url: 'https://static.wordai.pro/ai-generated-images/wynmotion/templates/cover_modern_motion_suite.png',
            video_demo_url: 'https://static.wordai.pro/ai-generated-images/wynmotion/WynMotion_Modern_Motion_Suite_Template.mp4',
            local_video_path: '/templates/WynMotion_Modern_Motion_Suite_Template.mp4',
            bgm_url: 'https://static.wordai.pro/ai-generated-images/wynmotion/WynMotion_Modern_Motion_Suite_Template.mp4',
            duration_sec: 50.1,
            max_images: 9,
            points_cost: 30,
            is_vip: false,
            badge: '✨ APPLE SUITE 50s',
            usage_count: '58.4K',
            ...
            default_params: {
              ...
              brand_company: 'WynAI',
              brand_logo_url: 'https://static.wordai.pro/ai-generated-images/wynmotion/templates/iconApp-WynAI-512.png',
              ...
              editor_ending_text: 'Create with AI. Edit with precision.',
