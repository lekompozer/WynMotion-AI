      ...
      if (isMounted && res && res.success && res.templates && res.templates.length > 0) {
        ...
        if (!hasAppleModern) {
          validTemplates.push({
            ...
            video_demo_url: 'https://static.wordai.pro/ai-generated-images/wynmotion/WynMotion_Official_Intro_v9.mp4',
            local_video_path: '/templates/WynMotion_Official_Intro_v9.mp4',
            bgm_url: 'https://static.wordai.pro/ai-generated-images/wynmotion/templates/Intro-Music.mp3',
            duration_sec: 50.1,
            max_images: 9,
            points_cost: 30,
            is_vip: false,
