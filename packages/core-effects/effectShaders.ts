...
export const EFFECT_CATEGORIES = [
  { id: 'all', name: 'Tất cả', nameVi: 'Tất cả', nameEn: 'All' },
  { id: 'glitch', name: 'Glitch & Retro', nameVi: 'Glitch & Retro', nameEn: 'Glitch & Retro' },
  { id: 'light', name: 'Light & Glow', nameVi: 'Ánh sáng & Rực rỡ', nameEn: 'Light & Glow' },
  { id: 'distortion', name: 'Distortion & Blur', nameVi: 'Biến dạng & Mờ', nameEn: 'Distortion & Blur' },
  { id: 'color', name: 'Color & Art', nameVi: 'Màu sắc & Nghệ thuật', nameEn: 'Color & Art' },
  { id: 'camera', name: 'Camera & Film', nameVi: 'Máy quay & Phim nhựa', nameEn: 'Camera & Film' },
];
